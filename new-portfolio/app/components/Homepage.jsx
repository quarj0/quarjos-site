...
import MyImage from "@/assets/images/optimized/Plain pic.webp";
  ...
  return (
    <div itemScope itemType="https://schema.org/Person">
      ...
      <meta
        ...
        content="Software engineer and certified cybersecurity professional specializing in secure, scalable full-stack applications."
      />
        ...
        <div className="flex-1 flex flex-col md:flex-row items-center justify-between px-6 md:px-12">
          ...
          <div className="max-w-lg text-center md:text-left mt-5">
            ...
            <p className="text-blue-400 text-xs md:text-sm uppercase tracking-widest mb-6">
              Software Engineer | Aspiring Cybersecurity Analyst
            </p>
            <p className="text-gray-400 leading-relaxed text-sm md:text-base">
              Software engineer and certified cybersecurity professional
